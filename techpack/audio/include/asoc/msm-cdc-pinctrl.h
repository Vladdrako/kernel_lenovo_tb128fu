...
static inline int msm_cdc_pinctrl_select_alt_active_state(struct device_node *np)
{
	return 0;
}
...
static inline int msm_cdc_pinctrl_get_state(struct device_node *np)
{
	return true;
}
static inline int msm_cdc_pinctrl_set_wakeup_capable(struct device_node *np,
					      bool enable)
{
	return 0;
}
